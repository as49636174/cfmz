    ...
    <script>
        ...
        $(function () {
            $("#captchaImage").click(function () {
                $("#captchaImage").prop("src", "${pageContext.request.contextPath}/code/code1?time=" + new Date().getTime());
            });
        });
...
<div class="top-content">
    ...
    <div class="inner-bg">
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-6 col-sm-offset-3 form-box" style="margin-left:30%;">
                        ...
                        <form role="form" action="${pageContext.request.contextPath}/admin/login" method="post"
                            ...
                            <div class="form-group">
                                <img id="captchaImage" style="height: 48px" class="captchaImage"
                                     src="${pageContext.request.contextPath}/code/codeimage">
